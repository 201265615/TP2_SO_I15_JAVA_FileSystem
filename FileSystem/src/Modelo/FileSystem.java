...
public class FileSystem implements Funciones {
    ...
    public FileSystem() {
        this._Raiz = new Directorio("Raiz","C:",0,"Kevin",new Date(),null,null,0,null);
    ...
    public String file(String pContenido, String pExtension, String pNombre) {
        ...
        if(this._Actual.archivoExiste(pNombre, pExtension)){
            ...
            if(!sectoresArchivo.isEmpty()){
                ...
                this._Actual.getContenido().add(new Archivo(pContenido,pExtension,pNombre,this._RutaActual,pContenido.length(),"Kevin",new Date(),null,sectoresArchivo,0));
    ...
    public void help(){
        String ayuda = "** Menu de ayuda ** \n " +
                       " Para navegar por el sistema de archivos ejecute los siguientes comandos: \n" +
                       "1- CREATE cantSectores tamSector \n"+
